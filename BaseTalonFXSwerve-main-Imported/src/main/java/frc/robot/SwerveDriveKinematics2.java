 ...
 */
public class SwerveDriveKinematics2 {
   ...
   *                                 the robot.
   */
  public SwerveDriveKinematics2(Translation2d... moduleTranslationsMeters) {
  ...
  public SwerveModuleState[] toSwerveModuleStates(
      ChassisSpeeds chassisSpeeds, Translation2d centerOfRotationMeters, boolean isDrifting) {
    ...
    for (int i = 0; i < m_numModules; i++) {
      ...
      if (i == 0 || i == 2) {
        moduleStates[i] = new SwerveModuleState(isDrifting ? Constants.Swerve.maxSpeed : speed, new Rotation2d());
  ...
  public SwerveModuleState[] toSwerveModuleStates(ChassisSpeeds chassisSpeeds) {
    return toSwerveModuleStates(chassisSpeeds, new Translation2d(), false);
  }
